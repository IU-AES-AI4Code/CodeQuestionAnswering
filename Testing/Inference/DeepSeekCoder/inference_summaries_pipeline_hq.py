...
def get_args():
    ...
    parser.add_argument("--name", type=str, default='DeepSeekCoderSummariesHQ')
    parser.add_argument("--checkpoint", type=str, default='./DeepSeekSummaries/merged')
    parser.add_argument("--dataset", type=str, default='datapaf/UCQAQualitySubsetSummariesBenchmark')
...
if __name__ == "__main__" :
    ...
    for i in tqdm(range(len(dataset))):
        ...
        prompt = prompt_template.format(code=code, summary=summary, question=question)
